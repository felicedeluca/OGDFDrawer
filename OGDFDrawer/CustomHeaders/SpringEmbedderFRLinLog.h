 ...
 * last checkin:
 *   $Author: deluca $
 *   $Date: 2016-05-12 09:54:22 +0200 (Wednesday, 12 Jun 2016) $
 ***************************************************************/
...
#ifndef OGDF_SPRING_EMBEDDER_FR_LINLOG_H
#define OGDF_SPRING_EMBEDDER_FR_LINLOG_H
...
class OGDF_EXPORT SpringEmbedderFRLinLog : public ForceLayoutModule
{
public:
	enum CoolingFunction { cfFactor, cfLogarithmic };

	//! Creates an instance of Fruchterman/Reingold (LinLog) layout.
	SpringEmbedderFRLinLog();
...
private:
	...
	// LinLog (mine)
	//double f_att(double d) { return K; }
	//double f_rep(double d) { return K / d; }
